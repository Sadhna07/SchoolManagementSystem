...
class StudentInfosControllerTest < ActionController::TestCase
  ...
  test "should create student_info" do
    assert_difference('StudentInfo.count') do
      post :create, student_info: { referenced_class_id: @student_info.referenced_class_id, student_id: @student_info.student_id, student_name: @student_info.student_name }
    end
  ...
  test "should update student_info" do
    patch :update, id: @student_info, student_info: { referenced_class_id: @student_info.referenced_class_id, student_id: @student_info.student_id, student_name: @student_info.student_name }
    assert_redirected_to student_info_path(assigns(:student_info))
  end
